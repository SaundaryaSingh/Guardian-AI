...
~/.openclaw-finance/config.json, or set FRED_API_KEY env var as fallback.
...
_FRED_NO_KEY_ERROR = (
    ...
    "~/.openclaw-finance/config.json, or export FRED_API_KEY env var. "
...
class EconomicsDataTool(Tool):
    ...
    Configure FRED key via tools.financial.fredApiKey in ~/.openclaw-finance/config.json
