...
class PriceMultiplesModel(BaseValuationModel):
    ...
    def validate_inputs(self, **kwargs) -> bool:
        """Input validation is handled by each individual calculate_* method."""
        return True

    def calculate(self, **kwargs) -> ValuationResult:
        """Use the specific calculate_*_ratio / value_using_* methods directly."""
        raise NotImplementedError(
            "PriceMultiplesModel has no single calculate() entrypoint. "
            "Use calculate_pe_ratio(), value_using_pe_multiple(), etc."
        )
...
class EnterpriseValueMultiplesModel(BaseValuationModel):
    ...
    def calculate(self, **kwargs) -> ValuationResult:
        """Use the specific calculate_ev_* / value_using_ev_multiple methods directly."""
        raise NotImplementedError(
            "EnterpriseValueMultiplesModel has no single calculate() entrypoint. "
            "Use calculate_ev_ebitda(), value_using_ev_multiple(), etc."
        )
